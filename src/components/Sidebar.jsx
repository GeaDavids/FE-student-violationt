...
const Sidebar = ({ onKelolaUserClick, isMobileOpen, setIsMobileOpen }) => {
  ...
  // Responsive: show/hide sidebar in mobile
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed z-50 top-0 left-0 h-full bg-gradient-to-b from-slate-900 via-slate-800 to-blue-900 text-white shadow-2xl flex flex-col transition-all duration-300 ease-in-out
          ${isCollapsed ? "w-16" : "w-64"}
          ${isMobileOpen ? "translate-x-0" : "-translate-x-full"}
          md:static md:translate-x-0 md:min-h-screen md:flex
        `}
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-6 w-8 h-8 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-full items-center justify-center text-white shadow-lg transition-all duration-200 hover:scale-110 z-10 border-2 border-white hidden md:flex"
        ...
        <button
          onClick={() => setIsMobileOpen(false)}
          className="absolute right-2 top-4 w-8 h-8 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full flex items-center justify-center text-white shadow-lg z-20 md:hidden"
          title="Tutup Sidebar"
