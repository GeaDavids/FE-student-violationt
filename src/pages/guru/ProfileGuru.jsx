...
const ProfileGuru = () => {
  ...
  const [showPwSuccessAlert, setShowPwSuccessAlert] = useState(false);
  ...
  return (
    <div className="relative">
      ...
      {showSuccessAlert && (
        <div className="fixed top-6 right-6 z-[9999] bg-green-50 border border-green-300 text-green-800 px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 animate-fadeIn">
          <span className="text-2xl">✔</span>
          <span className="font-semibold">Profil berhasil diperbarui!</span>
        </div>
      )}
      {showPwSuccessAlert && (
        <div className="fixed top-20 right-6 z-[9999] bg-green-50 border border-green-300 text-green-800 px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 animate-fadeIn">
          <span className="text-2xl">✔</span>
