...
<<<<<<< HEAD
        <h3 className="text-sm font-semibold text-slate-900 mb-1">Memuat data...</h3>
=======
...
<<<<<<< HEAD
      ...
      setHistorySurat(Array.isArray(response.data.data) ? response.data.data : []);
      setPagination(prev => ({
=======
...
<<<<<<< HEAD
            <label className="block text-xs font-semibold text-slate-700">Nama Konfigurasi</label>
            <input
              type="text"
              value={formData.nama}
...
<<<<<<< HEAD
          ...
          <div className="space-y-1">
            <label className="block text-xs font-semibold text-slate-700">Jenis Surat</label>
            <select
          ...
          <div className="space-y-1">
            <label className="block text-xs font-semibold text-slate-700">Threshold (Score)</label>
            <input
              type="number"
          ...
          <div className="space-y-1">
            <label className="block text-xs font-semibold text-slate-700">Level Tingkat</label>
            <input
              type="number"
              value={formData.tingkat}
              onChange={(e) => setFormData(prev => ({ ...prev, tingkat: parseInt(e.target.value) }))}
              className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all duration-200 text-slate-900 font-medium text-sm"
        ...
        <div className="space-y-1">
          <label className="block text-xs font-semibold text-slate-700">Judul Template</label>
          <input
            type="text"
            value={formData.judulTemplate}
            onChange={(e) => setFormData(prev => ({ ...prev, judulTemplate: e.target.value }))}
            className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all duration-200 text-slate-900 font-medium text-sm"
        ...
        <div className="space-y-1">
          <label className="block text-xs font-semibold text-slate-700">Isi Template</label>
          <textarea
            value={formData.isiTemplate}
            onChange={(e) => setFormData(prev => ({ ...prev, isiTemplate: e.target.value }))}
            rows={6}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-xs text-blue-700 font-medium mb-2">📝 Placeholder yang tersedia:</p>
            <div className="grid grid-cols-3 gap-1 text-xs">
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{NAMA_SISWA}"}</code>
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{KELAS}"}</code>
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{TOTAL_SCORE}"}</code>
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{NISN}"}</code>
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{TANGGAL}"}</code>
              <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono">{"{NAMA_ORTU}"}</code>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg border border-slate-200">
          ...
          />
          <label className="text-xs font-semibold text-slate-700">Aktifkan konfigurasi ini</label>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1 text-sm">Kelola konfigurasi dan pantau riwayat surat peringatan otomatis</p>
                </div>
              </div>
              ...
              <div>
                {safeConfigs.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900 mb-1">Belum ada konfigurasi</h3>
                    <p className="text-slate-500 text-sm max-w-sm mx-auto mb-4">Konfigurasi surat peringatan akan muncul di sini setelah Anda menambahkannya</p>
                    <button
                  ...
                  <div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                      <div>
                        <h2 className="text-lg font-bold text-slate-900">Daftar Konfigurasi Surat</h2>
                        <p className="text-sm text-slate-600">Kelola template surat peringatan otomatis</p>
                      </div>
                      <button
                        onClick={() => setShowCreateModal(true)}
                        className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg"
                        ...
                        >
                          <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex items-center gap-3">
                                <div className="p-2 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg shadow-lg">
                                  <span className="text-lg">{getSuratTypeIcon(config.jenisSurat)}</span>
                                </div>
                                <div>
                                  <h3 className="text-lg font-bold text-slate-900 mb-1">{config.nama}</h3>
                                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border ${getSuratTypeColor(config.jenisSurat)}`}>
                                    {config.jenisSurat}
                                  </span>
                                </div>
                              </div>
                              <div className="flex items-center gap-1.5">
                                <div className={`w-2.5 h-2.5 rounded-full shadow-sm ${config.isActive ? 'bg-emerald-500' : 'bg-slate-300'}`}></div>
                            ...
                            <div className="space-y-3 mb-6">
                              <div className="bg-slate-50 rounded-lg p-3 space-y-2">
                                <div className="flex justify-between items-center">
                                  <span className="text-xs font-medium text-slate-600">Threshold Score</span>
                                  <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div>
                                    <span className="text-sm font-bold text-slate-900">{config.threshold}</span>
                                  </div>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span className="text-xs font-medium text-slate-600">Level Tingkat</span>
                                  <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 bg-indigo-500 rounded-full"></div>
                                    <span className="text-sm font-bold text-slate-900">{config.tingkat}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
              ...
              <div>
                {safeHistorySurat.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900 mb-1">Belum ada riwayat surat</h3>
                    <p className="text-slate-500 text-sm max-w-sm mx-auto">Riwayat surat peringatan akan muncul di sini setelah sistem mengirim surat</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {safeHistorySurat.map((surat) => (
                      <div key={surat.id} className="bg-white border border-slate-200/60 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                        <div className="p-6">
                          <div className="flex justify-between items-start mb-4">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-3">
                                <div className="p-2 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg shadow-lg">
                                  <span className="text-lg text-white">{getSuratTypeIcon(surat.jenisSurat)}</span>
                                </div>
                                <div>
                                  <h4 className="text-lg font-bold text-slate-900 mb-1">{surat.judul}</h4>
                                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border ${getSuratTypeColor(surat.jenisSurat)}`}>
                                    {surat.jenisSurat}
                                  </span>
                                </div>
                              </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div className="bg-slate-50 rounded-lg p-3">
                                  <span className="text-xs font-medium text-slate-600 block mb-1">Informasi Siswa</span>
                                  <div className="space-y-1">
                                    <p className="font-bold text-slate-900 text-sm">{surat.student?.nama}</p>
                                    <p className="text-xs text-slate-600">NISN: {surat.student?.nisn}</p>
                                    <p className="text-xs text-slate-600">Kelas: {surat.student?.kelas}</p>
                                  </div>
                                </div>
                                
                                <div className="bg-slate-50 rounded-lg p-3">
                                  <span className="text-xs font-medium text-slate-600 block mb-1">Detail Pelanggaran</span>
                                  <div className="space-y-1">
                                    <div className="flex items-center gap-1.5">
                                      <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
                                      <span className="text-sm font-bold text-slate-900">{surat.totalScoreSaat} Score</span>
                                    </div>
                                    <p className="text-xs text-slate-600">Level {surat.tingkatSurat}</p>
                                  </div>
                                </div>
                                
                                <div className="bg-slate-50 rounded-lg p-3">
                                  <span className="text-xs font-medium text-slate-600 block mb-1">Status Pengiriman</span>
                                  <div className="space-y-1">
                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${
                                      surat.statusKirim === 'sent' ? 'bg-emerald-100 text-emerald-700 border border-emerald-200' : 
                                      surat.statusKirim === 'pending' ? 'bg-yellow-100 text-yellow-700 border border-yellow-200' : 
                                      'bg-red-100 text-red-700 border border-red-200'
                                    }`}>
                                      {surat.statusKirim === 'sent' ? '✓ Terkirim' : surat.statusKirim === 'pending' ? '⏳ Pending' : '✗ Gagal'}
                                    </span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center gap-3 text-xs text-slate-500 bg-slate-50 rounded-lg p-3">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span>Dibuat: {new Date(surat.createdAt).toLocaleDateString('id-ID', {
                                    day: 'numeric',
                                    month: 'long',
                                    year: 'numeric',
                                    hour: '2-digit',
                                ...
                                {surat.tanggalKirim && (
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-emerald-600 font-medium">Dikirim: {new Date(surat.tanggalKirim).toLocaleDateString('id-ID', {
                                      day: 'numeric',
                                      month: 'long',
                                      year: 'numeric'
                                    })}</span>
...
<<<<<<< HEAD
                    <h3 className="text-lg font-bold text-slate-900">Detail Konfigurasi Surat</h3>
=======
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                      <p className="text-sm font-medium text-slate-900">{selectedConfig.nama}</p>
                    </div>
                  </div>
                  <div className="space-y-1">
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Jenis Surat</label>
                    <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold border ${getSuratTypeColor(selectedConfig.jenisSurat)}`}>
=======
...
>>>>>>> main
                  ...
                  <div className="space-y-1">
<<<<<<< HEAD
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Threshold Score</label>
                    <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                      <p className="text-sm font-bold text-slate-900">{selectedConfig.threshold} score</p>
                    </div>
                  </div>
                  <div className="space-y-1">
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Level Tingkat</label>
                    <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                      <p className="text-sm font-bold text-slate-900">Level {selectedConfig.tingkat}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <p className="text-slate-900 font-medium text-sm">{selectedConfig.judulTemplate}</p>
                  </div>
                </div>
                
                <div className="space-y-1">
                  <label className="block text-xs font-semibold text-slate-700 mb-1">Isi Template</label>
                  <div className="p-4 bg-slate-50 rounded-lg border border-slate-200 max-h-60 overflow-y-auto">
                    <pre className="whitespace-pre-wrap font-sans text-slate-900 leading-relaxed text-sm">{selectedConfig.isiTemplate}</pre>
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="block text-xs font-semibold text-slate-700 mb-1">Status Konfigurasi</label>
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <div className={`w-3 h-3 rounded-full shadow-sm ${selectedConfig.isActive ? 'bg-emerald-500' : 'bg-slate-400'}`}></div>
                    <span className={`text-sm font-bold ${selectedConfig.isActive ? 'text-emerald-600' : 'text-slate-500'}`}>
...
<<<<<<< HEAD
                    <h3 className="text-lg font-bold text-slate-900">Buat Konfigurasi Baru</h3>
=======
                    <h3 className="text-lg font-bold text-slate-900">
...
<<<<<<< HEAD
                    <h3 className="text-lg font-bold text-slate-900">Edit Konfigurasi</h3>
=======
                    <h3 className="text-lg font-bold text-slate-900">
                      Edit Konfigurasi
                    </h3>
